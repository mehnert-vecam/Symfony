...
{ 
    ...
    return $this->renderTemplate('VestResponsaBundle:Default:antwort_overview.html.twig', array('data' => $uebergabe, 'umfrage' => $umfrage, 'leer' => $leer, 'f_name' => $f_name, 'u_id' => $u_id));
    ...
    return $this->renderTemplate('VestResponsaBundle:Default:antwort_overview.html.twig', array('data' => $uebergabe, 'leer' => $leer, 'f_name' => $f_name, 'u_id' => $u_id, 'umfrage' => $umfrage));
