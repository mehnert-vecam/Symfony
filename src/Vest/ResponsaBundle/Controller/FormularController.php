...
use Vest\ResponsaBundle\Entity\AddrStatus;
...
class FormularController extends Controller
{
    public function indexAction($id='')
    {
        ...
        $repository = $this->getDoctrine()->getRepository('VestResponsaBundle:AddrStatus');// Baut Doctrine auf
        ...
        return $this->renderTemplate('VestResponsaBundle:Default:new.html.twig', array(
    ...
    public function saveAction(Request $request)
    {
        ...
        $task = new AddrStatus(); 
        $repository = $this->getDoctrine()->getRepository('VestResponsaBundle:AddrStatus');
    ...
    public function ErfolgAction($ergebnis)
    {
        ...
        return $this->renderTemplate('VestResponsaBundle:Default:erfolg.html.twig', array('ergebnis' => $ergebnis));
    } 
    public function FailAction($ergebnis)
    {
        

        return $this->renderTemplate('VestResponsaBundle:Default:fail.html.twig', array('ergebnis' => $ergebnis));
    }
