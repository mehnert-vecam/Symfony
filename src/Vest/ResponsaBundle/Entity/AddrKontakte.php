...
class AddrKontakte
{
    ...
    {
//        $this->addrPersonen = new \Doctrine\Common\Collections\ArrayCollection();
    }
    ...
    public function setAddrpersonen(\Vest\ResponsaBundle\Entity\AddrPersonen $addrpersonen = null)
    {
        $this->addrpersonen = $addrpersonen;

        return $this;
    }
    public function getAddrpersonen()
    {
        return $this->addrpersonen;
    }
     ...
     * Add addrpersonen
     *
     * @param \Vest\ResponsaBundle\Entity\AddrPersonen $addrpersonen
     * @return AddrKontakte
     */
    public function addAddrpersonen(\Vest\ResponsaBundle\Entity\AddrPersonen $addrpersonen)
    {
        $this->addrpersonen[] = $addrpersonen;
     ...
     * @param \Vest\ResponsaBundle\Entity\AddrPersonen $addrpersonen
     */
    public function removeAddrpersonen(\Vest\ResponsaBundle\Entity\AddrPersonen $addrpersonen)
    {
        $this->addrpersonen->removeElement($addrpersonen);
    }
}
