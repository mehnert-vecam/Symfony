...
{ 
	public function OverviewAction(){
		$uebergabe = array();
		$repository = $this->getDoctrine()->getRepository('VestSymfonyBundle:Resumfrage');// Baut Doctrine auf 
		...
		*/
    return $this->render('VestSymfonyBundle:Default:umfrage_overview.html.twig', array('data' => $umfragen));  
	...
	public function NewAction($id = 0){
            ...
            $form  = $form ->getForm();
				...
				return $this->render('VestSymfonyBundle:Default:umfrage_form.html.twig', array(
